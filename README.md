...
The mod probally is highly compatible, but I only tested it for 1.4.7.

If you want to fix it yourself you can simply add: modifier_group="bow" to every sling weapon type (wool, braided and reinforced) and modifier_group="bolt" (or arrow instead of bolt) to every ammo type (stone, chiseled and lead) in the "weapons.xml" file found in C:\YourPathToSteam\steamapps\common\Mount & Blade II Bannerlord\Modules\SandBoxCore\ModuleData\items\weapons.xml. Use the fourth screenshot as a reference for where to put the line. If you want unique modifier groups either use this mod or edit the files "item_modifiers.xml" and "item_modifiers_groups.xml" found under C:\YourPathToSteam\steamapps\common\Mount & Blade II Bannerlord\Modules\Native\ModuleData\.
